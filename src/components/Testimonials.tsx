  ...
  return (
    <section className="relative py-24 md:py-32 bg-gray-50 dark:bg-dark/50">
      <div className="container-custom">
        ...
        >
          <span className="text-brand text-sm font-semibold tracking-widest uppercase">Testimonials</span>
        ...
        >
          {TESTIMONIALS.map((testimonial) => (
            ...
            >
              ...
              <p className="text-sm text-foreground/80 leading-relaxed mb-4">&ldquo;{testimonial.text}&rdquo;</p>
